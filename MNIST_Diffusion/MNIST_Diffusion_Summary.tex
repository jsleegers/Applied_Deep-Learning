...
In the case of this exercise, the features of the \textit{U-Net} went from $1 \rightarrow 32 \rightarrow 64 \rightarrow 160$ for the Downsampling and $160 \rightarrow 64 \rightarrow 32 \rightarrow 1$ for the Upsampling.
...
\begin{itemize}
  ...
  describing the amount of pixels per row/columns in the \textit{MNIST} dataset 
